...
/*F*/ _______      ,TO(_FS)      ,TO(_FD)      ,TO(_AS)      ,TO(_AD)      ,_______      ,_______        ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
/* */,_______      ,_______      ,TO(_L5)      ,TO(_L4)      ,TO(_L3)      ,_______      ,_______        ,_______      ,_______      ,TO(_L3)      ,TO(_L4)      ,TO(_L5)      ,_______      ,_______
/*H*/,_______      ,_______      ,_______      ,_______      ,TO(_NV)      ,_______                                    ,_______      ,TO(_NV)      ,_______      ,_______      ,_______      ,_______
/* */,_______      ,TO(_DW)      ,_______      ,TO(_DC)      ,_______      ,_______      ,_______        ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
/* */,_______      ,_______      ,_______      ,_______      ,_______                                                                ,_______      ,_______      ,_______      ,_______      ,_______
/*T*/                                                                      ,TO(_BT)      ,_______        ,_______      ,_______
/*T*/                                                                                    ,_______        ,_______
/*T*/                                                        ,TO(_BA)      ,_______      ,_______        ,_______      ,_______      ,TO(_BA)
...
/*F*/ KC_F1        ,KC_F2        ,KC_F3        ,KC_F4        ,KC_F5        ,KC_F6        ,CK_CYLAY_      ,_______      ,KC_F7        ,KC_F8        ,KC_F9        ,KC_F10       ,KC_F11       ,KC_F12
/* */,_______      ,_______      ,_______      ,SPC          ,_______      ,_______      ,_______        ,APP          ,_______      ,_______      ,KC_G         ,_______      ,_______      ,_______
/*H*/,_______      ,KC_U         ,KC_I         ,KC_A         ,KC_E         ,_______                                    ,_______      ,KC_N         ,KC_R         ,KC_T         ,KC_D         ,_______
/* */,DE_PL        ,DE_MI        ,_______      ,KC_L         ,_______      ,_______      ,_______        ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
/* */,_______      ,_______      ,_______      ,_______      ,_______                                                                ,_______      ,_______      ,_______      ,_______      ,_______
/*T*/                                                                      ,DEL          ,_______        ,HOME         ,END
/*T*/                                                                                    ,_______        ,_______
/*T*/                                                        ,_______      ,_______      ,_______        ,_______      ,_______      ,_______
...
/*H*/,_______      ,DE_AT        ,DE_EQL       ,DE_LABK      ,DE_RABK      ,_______                                    ,DE_ASTR      ,DE_LPRN      ,DE_RPRN      ,DE_TILD      ,DE_DLR       ,_______
/* */,_______      ,_______      ,CK_NEQ       ,_______      ,DE_PLUS      ,_______      ,_______        ,_______      ,_______      ,DE_LBRC      ,DE_RBRC      ,CKC_ELIP     ,DE_SECT      ,_______
/* */,_______      ,_______      ,_______      ,_______      ,_______                                                                ,_______      ,_______      ,_______      ,_______      ,_______
...
/*T*/                                                                      ,_______      ,_______        ,_______      ,_______
/*T*/                                                                                    ,_______        ,_______
/*T*/                                                        ,_______      ,_______      ,_______        ,_______      ,_______      ,SPC
), [_L5] = LAYOUT_ergodox_pretty(
// [layer 5]       | U **********| I **********| A **********| E **********| O **********|                             | S **********| N **********| R **********| T **********| D **********|*************
/*F*/ CKC_SUB1     ,CKC_SUB2     ,CKC_SUB3     ,CKC_SUB4     ,CKC_SUB5     ,CKC_SUB6     ,CK_CYLAY_      ,_______      ,CKC_SUB7     ,CKC_SUB8     ,CKC_SUB9     ,CKC_SUB0     ,CKC_SUBN     ,_______
...
/*H*/,_______      ,S(DE_UDIA)   ,CKC_AEQ      ,S(DE_ADIA)   ,_______      ,S(DE_ODIA)                                 ,_______      ,CKC_NOT      ,CKC_COPY     ,CKC_TM       ,_______      ,_______
...
/*H*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                    ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
/* */,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______        ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
/* */,_______      ,_______      ,_______      ,_______      ,_______                                                                ,_______      ,_______      ,_______      ,_______      ,_______
/*T*/                                                                      ,_______      ,_______        ,_______      ,_______
/*T*/                                                                                    ,_______        ,_______
...
/*F*/ DM_RSTP      ,DM_REC1      ,DM_REC2      ,DM_PLY1      ,DM_PLY2      ,CK_DBG       ,CK_CYLAY_      ,_______      ,RGB_TOG      ,CK_LMRES     ,KC_TAB       ,_______      ,_______      ,KC_WHOM
/* */,_______      ,_______      ,_______      ,_______      ,KC_CAPS      ,_______      ,RESET          ,KM_COPY      ,C(KC_HOME)   ,KC_HOME      ,KC_UP        ,KC_END       ,C(KC_END)    ,KC_VOLU
/*H*/,_______      ,KC_LWIN      ,KC_LALT      ,KC_LCTL      ,KC_LSFT      ,_______                                    ,KM_PAST      ,KC_LEFT      ,KC_DOWN      ,KC_RGHT      ,KC_PGUP      ,KC_VOLD
/* */,_______      ,C(DE_MINS)   ,C(DE_PLUS)   ,_______      ,KC_PAUS      ,KC_PSCR      ,KC_SLCK        ,KM_CUT       ,KC_INS       ,C(KC_LEFT)   ,KC_DEL       ,C(KC_RGHT)   ,KC_PGDN      ,KC_MUTE
...
/*T*/                                                                                    ,_______        ,_______
/*T*/                                                        ,KC_LSFT      ,_______      ,_______        ,_______      ,_______      ,KC_RSFT
...
/*H*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                    ,_______      ,KC_4         ,KC_5         ,KC_6         ,_______      ,_______
...
/*F*/ _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,CK_CYLAY_      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
...
/*H*/,_______      ,_______      ,CKC_TRIO_W   ,CKC_TRIO_S   ,CKC_TRIO_E   ,_______                                    ,_______      ,CKC_ARR_W1   ,CKC_ARR_S1   ,CKC_ARR_E1   ,CKC_ARR_WE1  ,_______
...
/*H*/,_______      ,_______      ,CKC_TRIF_W   ,CKC_TRIF_S   ,CKC_TRIF_E   ,_______                                    ,_______      ,CKC_ARR_W2   ,CKC_ARR_S2   ,CKC_ARR_E2   ,CKC_ARR_WE2  ,_______
...
/*H*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                    ,CKC_FRM_VL1  ,CKC_FRM_W1   ,CKC_FRM_CR1  ,CKC_FRM_E1   ,CKC_FRM_HL1  ,_______
...
/*H*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                    ,CKC_FRM_VL2  ,CKC_FRM_W2   ,CKC_FRM_CR2  ,CKC_FRM_E2   ,CKC_FRM_HL2  ,_______
