...
// layers
#define L_BA	0	//base
#define L_LS	1	//left shift
#define L_RS	2	//right shift
#define L_Y1	3	//symbols 1
#define L_Y2	4	//symbols 2
...
layer_state_t layer_state_set_user(layer_state_t state) {
	state = update_tri_layer_state(state, L_LS, L_RS, L_Y2);
	...
	// (Replacing MO(L_LS) with LM(L_LS, 0) in base layer did not help.)
...
,KC_APP       ,KC_LWIN      ,(      KC_BSPC      )      ,( LM(L_LS,MOD_LSFT) )      ,KC_TAB       ,KC_ENTER   ,( LM(L_RS,MOD_LSFT) )      ,(      TT(L_NV)      )     ,KC_LALT      ,KC_LCTL      ,KC_LEFT      ,KC_DOWN      ,KC_RGHT
),
[L_LS] = LAYOUT( //left shift
...
,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,_______      ,_______      ,_______      ,_______      ,_______                    ,_______
,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(     MO(L_RS)      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
),
[L_RS] = LAYOUT( //right shift
 _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,(      _______      )
,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,DE_EXLM            ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,_______
,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,_______      ,_______      ,_______      ,_______      ,_______                    ,_______
,_______      ,_______      ,(      _______      )      ,(     MO(L_LS)      )      ,_______      ,_______    ,(     _______       )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
),
