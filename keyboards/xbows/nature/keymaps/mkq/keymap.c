...
// layers
#define _BA	 0	//base
#define _Y1	 1	//symbols 1 (<= TT from base layer)
#define _Y2	 2	//symbols 2 (<= LShift + RShift)
#define _Y3	 3	//symbols 3 (<= _Y1 + Shift)
...
// Row label comments: N = numbers; F = function keys; u = upper (letters); h = home; l = lower (letters); T = thumb
...
/*u*/,DE_CIRC      ,LT(_FD,KC_X) ,LT(_FS,KC_V) ,LT(_AD,SPC)  ,LT(_AS,KC_C) ,KC_W                                   ,KC_K         ,KC_H         ,KC_G         ,KC_F         ,DE_Y         ,KC_CAPS      ,KC_HOME      ,KC_END       ,KC_PGUP
/*h*/,TT(_Y1)      ,LWIN_T(KC_U) ,LALT_T(KC_I) ,LCTL_T(KC_A) ,LT(_NV,KC_E) ,KC_O               ,CK_DE_QEX          ,KC_S         ,LT(_NV,KC_N) ,RCTL_T(KC_R) ,LALT_T(KC_T) ,RWIN_T(KC_D) ,TT(_Y1)     ,(      KC_SPC       )       ,KC_PGDN
/*l*/,KC_ESC       ,DE_MINS      ,CK_DE_SLBS   ,KC_L         ,KC_P         ,DE_Z               ,DE_SECT            ,KC_B         ,KC_M         ,DE_COMM      ,DE_DOT       ,KC_J         ,KC_Q                       ,KC_UP
/*T*/,KC_APP       ,KC_LWIN      ,(      KC_BSPC      )      ,(      KC_LSFT      )      ,KC_TAB       ,KC_ENTER   ,(      KC_RSFT      )      ,(      TT(_NV)       )     ,KC_LALT      ,KC_LCTL      ,KC_LEFT      ,KC_DOWN      ,KC_RGHT
...
/*u*/,_______      ,DE_PERC      ,DE_AMPR      ,DE_DQUO      ,DE_QUOT      ,DE_GRV                                 ,DE_HASH      ,DE_LCBR      ,DE_RCBR      ,DE_PIPE      ,_______      ,_______      ,_______      ,_______      ,_______
/*h*/,_______      ,DE_UDIA      ,_______      ,DE_ADIA      ,DE_AT        ,DE_ODIA            ,_______            ,DE_ASTR      ,DE_LPRN      ,DE_RPRN      ,DE_TILD      ,DE_DLR       ,_______      ,(      _______      )      ,_______
/*l*/,_______      ,DE_PLUS      ,DE_EQL       ,DE_LABK      ,DE_RABK      ,DE_SS              ,_______            ,_______      ,DE_LBRC      ,DE_RBRC      ,_______      ,DE_SECT      ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      MO(_Y3)      )      ,_______      ,_______    ,(      MO(_Y3)      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
...
/*F*/,_______      ,_______      ,_______      ,_______      ,DE_ACUT      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
/*u*/,_______      ,KC_PSLS      ,KC_PAST      ,KC_PMNS      ,KC_PPLS      ,_______                                ,DE_SLSH      ,KC_7         ,KC_8         ,KC_9         ,DE_COLN      ,_______      ,_______      ,_______      ,_______
/*h*/,_______      ,S(DE_UDIA)   ,_______      ,S(DE_ADIA)   ,DE_EURO      ,S(DE_ODIA)         ,_______            ,DE_ASTR      ,KC_4         ,KC_5         ,KC_6         ,DE_DOT       ,_______      ,(      _______      )      ,_______
/*l*/,_______      ,DE_MINS      ,CK_NEQ       ,_______      ,DE_PLUS      ,RSA(DE_SS)         ,_______            ,KC_0         ,KC_1         ,KC_2         ,KC_3         ,DE_COMM      ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      XXXXXXX      )      ,_______      ,_______    ,(      XXXXXXX      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
...
/*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
/*u*/,X(DCIRC)     ,_______      ,_______      ,X(DDIA)      ,X(DACUT)     ,X(DGRV)                                ,_______      ,_______      ,_______      ,X(DTILD)     ,_______      ,_______      ,_______      ,_______      ,_______
/*h*/,_______      ,_______      ,_______      ,_______      ,_______      ,X(DDEGR)           ,_______            ,_______      ,X(NOT)       ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,_______
/*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,_______      ,X(DCEDI)     ,_______      ,_______      ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
), [_AS] = LAYOUT( //arrows ***********************************************************************|************************************************************************************************|**************************************
/*N*/ _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,(      _______      )
/*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
/*u*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,X(ARR_NW)    ,X(ARR_N)     ,X(ARR_NE)    ,_______      ,_______      ,_______      ,_______      ,_______
...
/*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,X(ARR_SW)    ,X(ARR_S)     ,X(ARR_SE)    ,X(ARR_WE)    ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
), [_AD] = LAYOUT( //double arrows ****************************************************************|************************************************************************************************|**************************************
/*N*/ _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,(      _______      )
/*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
/*u*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,X(ARR_NW2)   ,X(ARR_N2)    ,X(ARR_NE2)   ,_______      ,_______      ,_______      ,_______      ,_______
...
/*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,X(ARR_SW2)   ,X(ARR_S2)    ,X(ARR_SE2)   ,X(ARR_WE2)   ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
), [_FS] = LAYOUT( //frames ***********************************************************************|************************************************************************************************|**************************************
/*N*/ _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,(      _______      )
/*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
/*u*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,X(FRM_NW)    ,X(FRM_N)     ,X(FRM_NE)    ,_______      ,_______      ,_______      ,_______      ,_______
...
/*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,X(FRM_SW)    ,X(FRM_S)     ,X(FRM_SE)    ,X(FRM_HL)    ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
), [_FD] = LAYOUT( //double frames ****************************************************************|************************************************************************************************|**************************************
/*N*/ _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,(      _______      )
/*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
/*u*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,X(FRM_NW2)   ,X(FRM_N2)    ,X(FRM_NE2)   ,_______      ,_______      ,_______      ,_______      ,_______
...
/*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,X(FRM_SW2)   ,X(FRM_S2)    ,X(FRM_SE2)   ,X(FRM_HL2)   ,_______                    ,_______
/*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
...
/*F*/,LWIN(KC_1)   ,LWIN(KC_2)   ,LWIN(KC_3)   ,LWIN(KC_4)   ,LWIN(KC_5)   ,LWIN(KC_6)                             ,LWIN(KC_7)   ,LWIN(KC_8)   ,LWIN(KC_9)   ,LWIN(KC_0)   ,_______      ,_______      ,_______      ,(      UC_MOD       )
/*u*/,_______      ,C(KC_6)      ,C(KC_7)      ,C(KC_8)      ,C(KC_9)      ,C(KC_0)                                ,C(KC_HOME)   ,KC_HOME      ,KC_UP        ,KC_END       ,C(KC_END)    ,_______      ,KC_WWW_HOME  ,KC_MSEL      ,KC_VOLU
/*h*/,_______      ,KC_LWIN      ,KC_LALT      ,KC_LCTL      ,_______      ,_______            ,DM_PLY1            ,S(KC_INS)    ,KC_LEFT      ,KC_DOWN      ,KC_RGHT      ,KC_PGUP      ,_______      ,(      KC_MUTE      )      ,KC_VOLD
/*l*/,C(KC_PLUS)   ,C(KC_1)      ,C(KC_2)      ,C(KC_3)      ,C(KC_4)      ,C(KC_5)            ,DM_PLY2            ,KC_INS       ,C(KC_LEFT)   ,KC_DEL       ,C(KC_RGHT)   ,KC_PGDN      ,_______                    ,KC_MSTP
...
///*N*/ RESET        ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,KC_CALC      ,KC_MYCM      ,KC_MSEL      ,KC_MAIL      ,(      NK_TOGG       )     ,(      EEP_RST      )
///*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      KC_NLCK      )
///*u*/,RGB_TOG      ,RGB_MOD      ,RGB_VAI      ,RGB_HUI      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,KC_HOME
///*h*/,_______      ,RGB_SPD      ,RGB_VAD      ,RGB_SPI      ,_______      ,_______            ,_______            ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,KC_END
///*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,_______      ,_______      ,_______      ,_______      ,KC_MUTE                    ,KC_VOLU
///*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,KC_MPLY      ,KC_MPRV      ,KC_VOLD      ,KC_MNXT
)};
...
///*N*/ _______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______    ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )      ,(      _______      )
///*F*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,(      _______      )
///*u*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______                                ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______      ,_______
...
///*l*/,_______      ,_______      ,_______      ,_______      ,_______      ,_______            ,_______            ,_______      ,_______      ,_______      ,_______      ,_______      ,_______                    ,_______
///*T*/,_______      ,_______      ,(      _______      )      ,(      _______      )      ,_______      ,_______    ,(      _______      )      ,(      _______      )      ,_______      ,_______      ,_______      ,_______      ,_______
